...
function BookingForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" style={{ width: "100%", padding: ".9rem", background: "linear-gradient(135deg,var(--gold),var(--gold-lt))", color: "#040200", fontWeight: 700, fontSize: ".88rem", letterSpacing: ".07em", textTransform: "uppercase", borderRadius: 50, boxShadow: "0 6px 28px rgba(201,168,76,.35)", cursor: "pointer", border: "none" }}>
        Request Booking
      </button>
    </form>
  );
